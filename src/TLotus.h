...
private:
	...
	[[nodiscard]] std::pair<bool, size_t> _get_state_of_Y(size_t i,
	                                                      size_t index_in_TStorage_Y_vector) const;
	[[nodiscard]] std::pair<bool, size_t> _get_state_of_L(size_t i,
	                                                      size_t index_in_TStorage_L_vector) const;
