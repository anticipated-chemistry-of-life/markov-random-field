    ...
    def decorator(f):
        opts = [
            ...
            click.option(
                ...
                type=int,
                default=None,
                help=f"Binned branch length for the {prefix} tree (default: random per node).",
            ),
            click.option(
                f"--{prefix}_mean_log_nu",
                type=float,
                default=None,
                help=f"Mean of log-nu for the {prefix} tree (default: random).",
            ),
            click.option(
                f"--{prefix}_var_log_nu",
                type=float,
                default=None,
                help=f"Variance of log-nu for the {prefix} tree (default: random).",
            ),
            click.option(
                f"--{prefix}_log_nu",
                type=float,
                default=None,
                help=f"log-nu value for the {prefix} tree (default: random per clique).",
            ),
            click.option(
                f"--{prefix}_alpha",
                type=float,
                default=None,
                help=f"Alpha (Ising coupling strength) for the {prefix} tree (default: random per clique).",
            ),
        ]
